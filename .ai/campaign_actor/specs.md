...
8. Toda criação de ator cria também seu `Inventory` na mesma operação; `CampaignActor.createMany` não é permitido.
9. A ficha mecânica é opcional; o ator continua válido sem ela.
10. Arquivar um ator define `archivedAt`, remove seu controlador e desfaz o vínculo com o Token sem apagar ficha ou inventário.
...
* Arquivar ator: preserva ficha, inventário e histórico do chat.
