...
* O MVP de Encounter Mode usa estado vivo em memoria no gateway realtime da campanha.
* Eventos `vtt:encounter:*` exigem socket autenticado dentro da campanha.
* Comandos de encontro que alteram estado exigem Mestre ativo da sessao.
* Encerrar a sessao remove o estado vivo de encontro junto com os demais estados transientes do VTT.
