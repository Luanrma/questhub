...
## O que e por que
`combat` modela o Encounter Mode generico sobre a mesa VTT. Ele permite que o Mestre inicie um encontro a partir de tokens escolhidos explicitamente na cena atual, defina iniciativa manualmente e avance turnos sem desmontar a mesa.

O objetivo do MVP e dar estrutura operacional de rodadas e turnos para combates, hazards e outros eventos situacionais, sem implementar regras mecanicas de sistemas como Pathfinder 2e ou D&D 5e.
