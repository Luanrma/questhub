...
## O que e por que
`encounter` modela o Encounter Mode generico sobre a mesa VTT. Ele permite que o Mestre inicie um encontro a partir de tokens escolhidos explicitamente na cena atual, defina iniciativa manualmente ou por rolagem rapida, e avance turnos sem desmontar a mesa.
...
* Mestre rola iniciativa de todos os participantes ativos de uma vez, sem animacao visual de dados, para organizar rapidamente a ordem de turno.
...
* Apenas o Mestre pode escolher participantes, iniciar, editar/rolar iniciativa, avancar turno, voltar turno ou encerrar encontro.
...
* A rolagem rapida de iniciativa de todos os envolvidos rola `1d20` para cada participante no servidor, sem animacao 3D, sem mensagem de chat e sem entrada no log de batalha; depois disso, o tracker e reordenado por maior iniciativa e o turno atual passa para o primeiro participante da lista.
* A pre-selecao para encontro nao move tokens no grid e nao altera a cena.
* Iniciativa e preenchida pelo Mestre, manualmente ou rolando `1d20` pelo icone de dado individual ou pela rolagem rapida de todos; nao ha calculo automatico de modificador.
...
* Calculo automatico de modificadores de iniciativa por ruleset.
