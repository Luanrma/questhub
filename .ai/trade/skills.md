...
* Optional Extension Boundary: trade/inventario nao pode ser pre-requisito para VTT core, tokens ou cenas.
...
* Nao importar contratos de item, inventario ou ruleset para `vtt` ou `campaign_scene`.
