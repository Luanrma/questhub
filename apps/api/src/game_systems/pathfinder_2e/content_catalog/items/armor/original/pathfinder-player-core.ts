...
export const PATHFINDER_PLAYER_CORE_ARMOR_ORIGINALS: readonly Pathfinder2eOriginalContentRecord<Pathfinder2eItemData>[] = [
  ...
  },
  {
    ...
    source: { sourcePack: 'equipment-srd', sourceId: 'Gq1cZWSKOtJhKd2p', slug: 'full-plate', publicationTitle: 'Pathfinder Player Core', license: 'ORC', remaster: true },
    image: { path: '/api/game-systems/pathfinder-2e/icons/equipment/armor/fullplate.webp' },
    data: {
      schemaVersion: 1,
      name: 'Full Plate',
      itemType: 'armor',
      ...
      category: 'heavy',
      group: 'plate',
      armor: { armorClassBonus: 6, dexterityCap: 0, checkPenalty: -3, speedPenaltyFeet: -10 },
    },
  },
]
