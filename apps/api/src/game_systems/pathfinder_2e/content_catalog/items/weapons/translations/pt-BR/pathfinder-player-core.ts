...
export const PATHFINDER_PLAYER_CORE_WEAPONS_PT_BR: readonly Pathfinder2eContentTranslation[] = [
  {
    ...
    fields: {
      ...
      itemType: 'arma',
      rarity: 'incomum',
      usage: 'empunhada em uma mão',
      category: 'marcial',
      group: 'espada',
      damageType: 'cortante',
      traits: { agile: 'ágil', backstabber: 'apunhaladora', finesse: 'acuidade', goblin: 'goblin' },
    },
  },
  {
    ...
    fields: {
      ...
      itemType: 'arma',
      rarity: 'comum',
      usage: 'empunhado em uma ou mais mãos',
      category: 'marcial',
      group: 'arco',
      damageType: 'perfurante',
      traits: { 'deadly-d10': 'mortal d10' },
    },
  },
]
