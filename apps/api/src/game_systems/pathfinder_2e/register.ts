...
import { registerGameSystemCharacterSheetManagerProvider } from '../actor-sheets'
import { registerGameSystemCatalogProvider } from '../catalog'
import { registerGameSystemInventoryPolicy } from '../inventory'
import { pathfinder2eCharacterSheetManagerProvider } from './actor-sheet/manager-provider'
import { registerPathfinder2eCharacterSheetRoutes } from './actor-sheet/routes'
