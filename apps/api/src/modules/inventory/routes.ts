...
import { getGameSystemInventoryPolicy } from '../../game_systems/inventory'
import type { GameSystemKey } from '../../game_systems/catalog'
...
async function findAuthorizedActor(campaignId: string, actorId: string, userId: string) {
  ...
  return canManage
    ? { actor: actor as AuthorizedActor, forbidden: false } as const
