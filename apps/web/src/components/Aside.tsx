...
export function Aside({
  ...
  const items = useMemo<NavItem[]>(
    () => [
      ...
      { to: `/campaign/${campaignId}/bestiary`, label: 'Bestiario', icon: <PawPrint size={18} /> },
      { to: `/campaign/${campaignId}/items`, label: 'Itens', icon: <Package size={18} /> },
      { to: `/campaign/${campaignId}/spells`, label: 'Magias', icon: <Sparkles size={18} /> },
