  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-white/10 bg-white/5 p-5">
        ...
        <p className="mt-1 text-sm text-zinc-300">Crie uma ficha escolhendo primeiro o sistema de jogo.</p>
      ...
      <section className="rounded-xl border border-white/10 bg-white/5 p-5">
        ...
        <div className="mt-4 grid gap-3">
          ...
          {sorted.map((character) => {
            ...
            const system = getGameSystemOption(character.gameSystem)
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="rounded-full border border-purple-300/20 bg-purple-400/10 px-2 py-0.5 text-[10px] text-purple-100">
                          {system?.label ?? character.gameSystem}
                        </span>
                        <span
                          className={[
