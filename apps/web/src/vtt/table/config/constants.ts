...
export const questhubHazardDragType = 'application/x-questhub-hazard-entry-id'
export const questhubNpcDefinitionDragType = 'application/x-questhub-npc-definition-id'
